...
> `Claude Prompts/README.md` for what that means. It is still re-surveyed every round prompt 22
...
survives — `gvb-site-handoff-v*.md` gets assembled from all twenty-one notes files each round.
