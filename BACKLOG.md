...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | Phase 7 — The print packet and the offline kit | `Numina` | 1 | Opus 5 | `claude/backlog-ranked-batch-yyjkwz` | [WISHLIST.md Phase 7](Numina/WISHLIST.md#phase-7--the-print-packet-and-the-offline-kit) |
