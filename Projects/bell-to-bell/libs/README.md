...
| `addons/libs/meshopt_decoder.module.js` | `src/world/models.js`, because the eight outfits, the eleven props and the picture frame are `EXT_meshopt_compression` `.glb` files (HISTORY.md #619, #624). 24,850 bytes, no worker, no fetch: its wasm is inlined |
