...
| `addons/libs/meshopt_decoder.module.js` | `src/world/models.js`, because the eight outfits are `EXT_meshopt_compression` `.glb` files (HISTORY.md #608). 24,850 bytes, no worker, no fetch: its wasm is inlined |
