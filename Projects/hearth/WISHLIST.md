...
**B1. The sprite pipeline (rank 34, ¼, Opus 5.5, gate `blender`).** Hearth's
...
**B2. The building sheet (rank 35, ½, Opus 5.5, gate `blender`).** The eight
...
**B3. Wiring the sheet (rank 36, ¼, Opus 5.5, no gate, after rank 35).**
