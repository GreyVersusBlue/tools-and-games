...
// Blender asset exists to feed it (BACKLOG.md "Golden Hour: Blender assets" B2).
...
// own folder, so `npm ci` there is the only install (Site CI's Golden Hour entry
...
try {
  ...
  result = await page.evaluate(async () => {
    ...
    const gltf = {
      asset: { version: '2.0', generator: 'golden-hour test/gltf-loader.mjs' },
      scene: 0,
      scenes: [{ nodes: [0, 1] }],
